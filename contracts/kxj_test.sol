...
//     address public loanPair;
//     ERC20 private _usdtToken;
//     ERC20 private _wbnbToken;
//     ERC20 _targetToken;
...
//         _wbnbToken = ERC20();
//         _targetToken = ERC20(0x5b56405Bb10841Dd282B44981E9743c60AE7E65a);

//         uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).getPair(
//             address(_usdtToken),
//             address(_targetToken)
//         );
//         loanPair = IUniswapV2Factory(uniswapV2Router.factory()).getPair(
//             address(_usdtToken),
//             address(_wbnbToken)
//         );
//     }
...
//         uint256[] memory amounts1 = uniRouter(router).swapExactTokensForTokens(
//             balance,
//             uint256(0),
//             path1,
//             address(this),
...
//         uint256[] memory amounts2 = uniRouter(router).swapExactTokensForTokens(
//             amounts1[1],
//             uint256(0),
//             path2,
//             address(this),
...
//         path3[0] = WETH;
//         path3[1] = USDT;
//         uint256[] memory amounts3 = uniRouter(router).getAmountsIn(
//             loanAmount,
//             path3
//         );
...
//         pair(USDTETH).swap(uint256(0), _loanAmount, address(this), _data);
//     }
